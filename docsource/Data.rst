...
.. content-tabs::
    ...
    .. tab-container:: tab3
        ...
        In order to understand the impact of the restrictive measures implemented in the UK (whose timeline is reported `here <https://bfpg.co.uk/2020/04/covid-19-timeline/>`_), we combined declarations from government officials (e.g. self-isolation of elderly or schools closure) and `the change in mobility of the UK population reported by their Android devices <https://www.google.com/covid19/mobility/>`_, which was transformed to a machine readable format using `this github repository <https://github.com/pastelsky/covid-19-mobility-tracker>`_. This restrictive measures and change in the mobility of population is reflected in the values of :math:`\alpha`s in our :ref:`Epidemic model <Model>`.
