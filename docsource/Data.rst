...
.. content-tabs::
    ...
    .. tab-container:: tab2
        ...
        As the NHS and UK governement dataset consider 5-year bands, we aggregated the contact matrix in order to match the data provided by NHS England.        
